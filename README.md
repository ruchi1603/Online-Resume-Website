...
It is a online resume website for creating Digital Resume. In this project we use [HTML5](https://en.wikipedia.org/wiki/HTML5 "LCO"), [CSS3](https://en.wikipedia.org/wiki/CSS "LCO") and [BootStrap](https://en.wikipedia.org/wiki/Bootstrap_(front-end_framework) "LCO"). It provides the searching facilities based on various factor. Such 
as Resume, Individual, Skills, Qualification. It tracks all the information of job, skills etc. Shows the information and description of the resume, Individual. You can easily export PDF for the Resume. And also it generates 
the report on resume, job. Editing, adding and updating of records is improved which results in proper resource management of resume.
